...
public class CreatePhraseHelper extends SQLiteOpenHelper {
    ...
    public CreatePhraseHelper(Context context) {
    ...
    public boolean insertData(String date, String subject, String action, String recetor, String artefact, String resource){
